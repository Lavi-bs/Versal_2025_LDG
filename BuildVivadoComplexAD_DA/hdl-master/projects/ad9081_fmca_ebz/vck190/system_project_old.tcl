...
adi_project ad9081_fmca_ebz_vck190 0 [list \
  ...
  RX_LANE_RATE      [get_env_param RX_LANE_RATE     4.0 ] \
  TX_LANE_RATE      [get_env_param TX_LANE_RATE     4.0 ] \
  REF_CLK_RATE      [get_env_param REF_CLK_RATE     400 ] \
  ...
  TX_KS_PER_CHANNEL [get_env_param TX_KS_PER_CHANNEL  4 ] \
]

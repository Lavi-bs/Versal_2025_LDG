...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pack_network is
  port (
    ...
    \ctrl_reg[18]_0\ : in STD_LOGIC_VECTOR ( 2 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pack_network is
  ...
  attribute SOFT_HLUTNM of \ctrl[2]_i_1__0\ : label is "soft_lutpair0";
...
\ctrl[2]_i_1__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"69996669"
    )
        port map (
...
architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pack_network__parameterized0\ is
  ...
  signal ctrl101_out : STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  attribute SOFT_HLUTNM of \ctrl[2]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \ctrl[3]_i_1\ : label is "soft_lutpair11";
...
\ctrl[2]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\ctrl[3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"6A"
    )
        port map (
...
\gen_input_buffer.i_ext_ctrl_interconnect\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pack_network
     port map (
      ...
      \ctrl_reg[18]_0\(2 downto 0) => prefix_count(14 downto 12),

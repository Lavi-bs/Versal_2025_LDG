...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sysid_rom is
  ...
  signal \rom_data[29]_i_1_n_1\ : STD_LOGIC;
  ...
  signal \rom_data[4]_i_5_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \rom_data[10]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \rom_data[12]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \rom_data[16]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \rom_data[17]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \rom_data[17]_i_3\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \rom_data[18]_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \rom_data[18]_i_3\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \rom_data[20]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rom_data[21]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rom_data[22]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \rom_data[24]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \rom_data[25]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \rom_data[25]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \rom_data[26]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \rom_data[28]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \rom_data[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \rom_data[31]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \rom_data[3]_i_3\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \rom_data[3]_i_4\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \rom_data[4]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \rom_data[4]_i_3\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \rom_data[4]_i_4\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rom_data[6]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \rom_data[6]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rom_data[6]_i_4\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rom_data[7]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rom_data[7]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \rom_data[7]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \rom_data[8]_i_3\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \rom_data[9]_i_1\ : label is "soft_lutpair0";
begin
\rom_data[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000044001010404"
    )
        port map (
...
\rom_data[17]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => rom_addr(1),
      I4 => rom_addr(0),
      I5 => \rom_data[17]_i_3_n_0\,
      O => \rom_data[17]_i_1_n_0\
    );
\rom_data[17]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\rom_data[17]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
\rom_data[18]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\rom_data[25]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0151"
    )
        port map (
      I0 => \rom_data[25]_i_2_n_0\,
      I1 => \rom_data[25]_i_3_n_0\,
      I2 => rom_addr(0),
      I3 => \rom_data[25]_i_4_n_0\,
...
\rom_data[29]_i_1\: unisim.vcomponents.LUT6_2
    generic map(
      INIT => X"0000000020000005"
    )
        port map (
      I0 => rom_addr(4),
      I1 => rom_addr(5),
      ...
      I3 => rom_addr(7),
      I4 => rom_addr(8),
      I5 => \rom_data[29]_i_2_n_0\,
      O5 => \rom_data[29]_i_1_n_0\,
      O6 => \rom_data[29]_i_1_n_1\
    );
\rom_data[29]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FECCFE9DFEEE7FFF"
    )
        port map (
      I0 => rom_addr(2),
      I1 => rom_addr(1),
...
\rom_data[3]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"3004"
    )
        port map (
...
\rom_data[3]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\rom_data[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \rom_data[4]_i_4_n_0\,
      I4 => \rom_data[4]_i_5_n_0\,
      I5 => rom_addr(2),
      O => \rom_data[4]_i_1_n_0\
    );
\rom_data[4]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0780"
    )
        port map (
...
\rom_data[4]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FB"
    )
        port map (
...
\rom_data[4]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EEEFFF2B"
    )
        port map (
...
\rom_data[4]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
      I0 => rom_addr(4),
      I1 => rom_addr(6),
      O => \rom_data[4]_i_5_n_0\
    );
\rom_data[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EE0000000000000E"
    )
        port map (
...
\rom_data[6]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
...
\rom_data[6]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\rom_data[7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => rom_addr(2),
      I3 => rom_addr(1),
      I4 => \rom_data[7]_i_3_n_0\,
      O => \rom_data[7]_i_1_n_0\
    );
\rom_data[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sysid_rom
     port map (
      ...
      rom_data(28 downto 21) => \^rom_data\(31 downto 24),

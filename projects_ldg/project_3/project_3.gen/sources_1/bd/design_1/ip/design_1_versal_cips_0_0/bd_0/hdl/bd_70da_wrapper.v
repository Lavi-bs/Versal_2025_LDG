...
module bd_70da_wrapper
  ...
  output [63:0]FPD_AXI_NOC_0_araddr;
  output [1:0]FPD_AXI_NOC_0_arburst;
  output [3:0]FPD_AXI_NOC_0_arcache;
  output [15:0]FPD_AXI_NOC_0_arid;
  output [7:0]FPD_AXI_NOC_0_arlen;
  output FPD_AXI_NOC_0_arlock;
  output [2:0]FPD_AXI_NOC_0_arprot;
  output [3:0]FPD_AXI_NOC_0_arqos;
  input FPD_AXI_NOC_0_arready;
  output [2:0]FPD_AXI_NOC_0_arsize;
  output [17:0]FPD_AXI_NOC_0_aruser;
  output FPD_AXI_NOC_0_arvalid;
  output [63:0]FPD_AXI_NOC_0_awaddr;
  output [1:0]FPD_AXI_NOC_0_awburst;
  output [3:0]FPD_AXI_NOC_0_awcache;
  output [15:0]FPD_AXI_NOC_0_awid;
  output [7:0]FPD_AXI_NOC_0_awlen;
  output FPD_AXI_NOC_0_awlock;
  output [2:0]FPD_AXI_NOC_0_awprot;
  output [3:0]FPD_AXI_NOC_0_awqos;
  input FPD_AXI_NOC_0_awready;
  output [2:0]FPD_AXI_NOC_0_awsize;
  output [17:0]FPD_AXI_NOC_0_awuser;
  output FPD_AXI_NOC_0_awvalid;
  input [15:0]FPD_AXI_NOC_0_bid;
  output FPD_AXI_NOC_0_bready;
  input [1:0]FPD_AXI_NOC_0_bresp;
  input FPD_AXI_NOC_0_bvalid;
  input [127:0]FPD_AXI_NOC_0_rdata;
  input [15:0]FPD_AXI_NOC_0_rid;
  input FPD_AXI_NOC_0_rlast;
  output FPD_AXI_NOC_0_rready;
  input [1:0]FPD_AXI_NOC_0_rresp;
  input FPD_AXI_NOC_0_rvalid;
  output [127:0]FPD_AXI_NOC_0_wdata;
  output FPD_AXI_NOC_0_wlast;
  input FPD_AXI_NOC_0_wready;
  output [15:0]FPD_AXI_NOC_0_wstrb;
  output FPD_AXI_NOC_0_wvalid;
  ...
  wire [63:0]FPD_AXI_NOC_0_araddr;
  wire [1:0]FPD_AXI_NOC_0_arburst;
  wire [3:0]FPD_AXI_NOC_0_arcache;
  wire [15:0]FPD_AXI_NOC_0_arid;
  wire [7:0]FPD_AXI_NOC_0_arlen;
  wire FPD_AXI_NOC_0_arlock;
  wire [2:0]FPD_AXI_NOC_0_arprot;
  wire [3:0]FPD_AXI_NOC_0_arqos;
  wire FPD_AXI_NOC_0_arready;
  wire [2:0]FPD_AXI_NOC_0_arsize;
  wire [17:0]FPD_AXI_NOC_0_aruser;
  wire FPD_AXI_NOC_0_arvalid;
  wire [63:0]FPD_AXI_NOC_0_awaddr;
  wire [1:0]FPD_AXI_NOC_0_awburst;
  wire [3:0]FPD_AXI_NOC_0_awcache;
  wire [15:0]FPD_AXI_NOC_0_awid;
  wire [7:0]FPD_AXI_NOC_0_awlen;
  wire FPD_AXI_NOC_0_awlock;
  wire [2:0]FPD_AXI_NOC_0_awprot;
  wire [3:0]FPD_AXI_NOC_0_awqos;
  wire FPD_AXI_NOC_0_awready;
  wire [2:0]FPD_AXI_NOC_0_awsize;
  wire [17:0]FPD_AXI_NOC_0_awuser;
  wire FPD_AXI_NOC_0_awvalid;
  wire [15:0]FPD_AXI_NOC_0_bid;
  wire FPD_AXI_NOC_0_bready;
  wire [1:0]FPD_AXI_NOC_0_bresp;
  wire FPD_AXI_NOC_0_bvalid;
  wire [127:0]FPD_AXI_NOC_0_rdata;
  wire [15:0]FPD_AXI_NOC_0_rid;
  wire FPD_AXI_NOC_0_rlast;
  wire FPD_AXI_NOC_0_rready;
  wire [1:0]FPD_AXI_NOC_0_rresp;
  wire FPD_AXI_NOC_0_rvalid;
  wire [127:0]FPD_AXI_NOC_0_wdata;
  wire FPD_AXI_NOC_0_wlast;
  wire FPD_AXI_NOC_0_wready;
  wire [15:0]FPD_AXI_NOC_0_wstrb;
  wire FPD_AXI_NOC_0_wvalid;

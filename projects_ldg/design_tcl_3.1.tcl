...
{PULL disable} {SCHMITT 0} {SLEW slow} {USAGE Reserved}}\
  ...
  connect_bd_net -net rst_versal_cips_0_295M_interconnect_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins rst_versal_cips_0_295M/interconnect_aresetn]

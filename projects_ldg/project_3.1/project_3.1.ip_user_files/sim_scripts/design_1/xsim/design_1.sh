...
# Set xvlog options
xvlog_opts="--incr --relax -L uvm -L axi_vip_v1_1_12 -L smartconnect_v1_0 -L cpm5_v1_0_7 -L cpm4_v1_0_7 -L versal_cips_ps_vip_v1_0_4 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_26 -L axi_vip_v1_1_12 -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L xlconstant_v1_1_7 -L versal_cips_ps_vip_v1_0_4 -L xil_defaultlib -L cpm4_v1_0_7 -L cpm5_v1_0_7 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_4 -L axi_gpio_v2_0_28 -L lib_pkg_v1_0_2 -L lib_srl_fifo_v1_0_2 -L axi_uartlite_v2_0_30 -L xlslice_v1_0_2 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_70da.protoinst" -protoinst "protoinst_files/bd_8be5.protoinst" -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/media/dewsjoe/Data/Vitis_2022_1/Vivado/2022.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
